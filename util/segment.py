...
class Segment(object):
    ...
    def create_synapse(self, _input):
    ...
    def old_firing_synapses(self, requiredConnection = True):
        '''
    ...
    def increase_permanences(self, byAmount):
        'increase permanence of all synapses in the segment'
        for s in self.synapses:
            s.permanence_increment(byAmount)

    @property
    def synapsesConnected(self):
        'return a list of all synapses whose connection is above threshold'
    ...
    def round_out_synapses(self, htm):
        ...
        if missingSynapses > 0:
            ...
            for _ in ramnge(missingSynapses):
